...
// Section: EXTERNS
extern volatile unsigned char hid_report_in_j1[HID_INT_IN_EP_SIZE_J1];
extern volatile unsigned char hid_report_out_j1[HID_INT_OUT_EP_SIZE_J1];
extern volatile CTRL_TRF_SETUP SetupPkt;
extern ROM BYTE configDescriptor1[];
extern volatile BYTE CtrlTrfData[USB_EP0_BUFF_SIZE];

#if !defined(__USB_DESCRIPTORS_C)
extern ROM struct{BYTE report[HID_RPT01_SIZE_J1];}hid_rpt01_j1;
#endif
