...
#define USB_SETUP_RECIPIENT_INTERFACE_BITFIELD_J1  (USB_SETUP_RECIPIENT_INTERFACE)     // Device Request bmRequestType recipient - interface
#define USB_SETUP_RECIPIENT_INTERFACE_BITFIELD_J2  (USB_SETUP_RECIPIENT_INTERFACE)     // Device Request bmRequestType recipient - interface
#define USB_SETUP_RECIPIENT_INTERFACE_BITFIELD_K1  (USB_SETUP_RECIPIENT_INTERFACE)     // Device Request bmRequestType recipient - interface
