 ...
 *******************************************************************/
	...
	volatile BDT_ENTRY BDT[(USB_MAX_EP_NUMBER + 1) * 4] __attribute__ ((aligned (512))) @ USBRAM_BDT;
#endif
 ...
 *******************************************************************/
	...
	volatile CTRL_TRF_SETUP SetupPkt @ USBRAM_CTRL_TRF_SETUP;           // 8-byte only
	volatile BYTE CtrlTrfData[USB_EP0_BUFF_SIZE] @ USBRAM_CTRL_TRF_DATA;
#else
...
// Can provide compile time option to do software pingpong
	...
	// These are all 64 bytes long
    volatile unsigned char hid_report_out_j1[HID_INT_OUT_EP_SIZE_J1] @ USBRAM_HID_REPORT_OUT_J1;
    volatile unsigned char hid_report_in_j1[HID_INT_IN_EP_SIZE_J1] @ USBRAM_HID_REPORT_IN_J1;

    volatile unsigned char hid_report_out_j2[HID_INT_OUT_EP_SIZE_J2] @ USBRAM_HID_REPORT_OUT_J2;
    volatile unsigned char hid_report_in_j2[HID_INT_IN_EP_SIZE_J2] @ USBRAM_HID_REPORT_IN_J2;

    volatile unsigned char hid_report_out_k1[HID_INT_OUT_EP_SIZE_K1] @ USBRAM_HID_REPORT_OUT_K1;
    volatile unsigned char hid_report_in_k1[HID_INT_IN_EP_SIZE_K1] @ USBRAM_HID_REPORT_IN_K1;
#endif
