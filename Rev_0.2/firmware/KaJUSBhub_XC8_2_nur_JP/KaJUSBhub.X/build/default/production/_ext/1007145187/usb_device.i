...
volatile BDT_ENTRY *pBDTEntryIn[3+1];
 ...
 WORD USBInMaxPacketSize[3];
 BYTE *USBInData[3];

# 480
volatile BDT_ENTRY BDT[(3 + 1) * 4]  @ 0x400;
...
# 511
volatile unsigned char hid_report_out_j1[64] @ 0x530;
volatile unsigned char hid_report_in_j1[64] @ 0x570;

volatile unsigned char hid_report_out_j2[64] @ 0x5B0;
volatile unsigned char hid_report_in_j2[64] @ 0x5F0;

volatile unsigned char hid_report_out_k1[1] @ 0x67A;
volatile unsigned char hid_report_in_k1[8] @ 0x67B;
