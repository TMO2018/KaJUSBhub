...
{
{ inPipes[0].pSrc.bRom = (const BYTE*)&configDescriptor1 + 18; inPipes[0].wCount.Val = sizeof(USB_HID_DSC_J1)+3; inPipes[0].info.Val = 0x40 | 0x80 | 0x00; };
...
if(USBActiveConfiguration == 1)
{
{ inPipes[0].pSrc.bRom = (const BYTE*)&hid_rpt01_j1; inPipes[0].wCount.Val = sizeof(hid_rpt01_j1); inPipes[0].info.Val = 0x40 | 0x80 | 0x00; };
...
break;
case 0x02:
{ inPipes[0].pSrc.bRam = (BYTE*)&idle_rate_j1; inPipes[0].wCount.Val = 1; inPipes[0].info.Val = 0x40 | 0x80 | 0x01; };
...
break;
case 0x03:
{ inPipes[0].pSrc.bRam = (BYTE*)&active_protocol_j1; inPipes[0].wCount.Val = 1; inPipes[0].info.Val = 0x00 | 0x80 | 0x01; };
