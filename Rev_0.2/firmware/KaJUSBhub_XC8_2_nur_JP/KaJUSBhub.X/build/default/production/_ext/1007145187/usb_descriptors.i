...
# 14 "../USB Stack/usb_descriptors.c"
...
const struct{BYTE bLength;BYTE bDscType;WORD string[10];}sd001={
sizeof(sd001),0x03,
{'S','i','m','o','n',' ','I','n','n','s'
}};
...
const struct{BYTE bLength;BYTE bDscType;WORD string[17];}sd003={
sizeof(sd003),0x03,
{'C','6','4',' ','J','o','y','s','t','i','c','k',' ','P','o','r','t'
}};


const struct{BYTE bLength;BYTE bDscType;WORD string[17];}sd004={
sizeof(sd004),0x03,
{'C','6','4',' ','J','o','y','s','t','i','c','k',' ','P','o','r','t'
}};


const struct{BYTE bLength;BYTE bDscType;WORD string[12];}sd005={
sizeof(sd005),0x03,
...
(const BYTE *const)&sd005
};

const struct{BYTE report[74];}hid_rpt01_j1={{
0x05,0x01,
0x09,0x05,
0xA1,0x01,
0x15,0x00,
...
const struct{BYTE report[74];}hid_rpt01_j2={{
0x05,0x01,
0x09,0x05,
0xA1,0x01,
0x15,0x00,
...
const struct{BYTE report[63];}hid_rpt01_k1={
{ 0x05, 0x01,
0x09, 0x06,
0xa1, 0x01,
0x05, 0x07,
