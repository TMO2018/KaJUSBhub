...
# 49 "../main.c"
__config("__CONFIG", "pic18", "USBPLL & IESODIS & FCMDIS & HSPLL & CPUDIV1 & PLLDIV5");

__config("__CONFIG", "pic18", "VREGEN & PWRTDIS & BOREN & BORV20 & WDTDIS & WDTPS32K");

__config("__CONFIG", "pic18", "PBDIGITAL & LPT1DIS & MCLREN");

__config("__CONFIG", "pic18", "XINSTDIS & STVREN & LVPDIS & ICPORTDIS & DEBUGDIS");

__config("__CONFIG", "pic18", "UNPROTECT");
__config("__CONFIG", "pic18", "UNPROTECT");
__config("__CONFIG", "pic18", "UNPROTECT");
...
if((USBDeviceState < CONFIGURED_STATE)||(SUSPND==1))
{
