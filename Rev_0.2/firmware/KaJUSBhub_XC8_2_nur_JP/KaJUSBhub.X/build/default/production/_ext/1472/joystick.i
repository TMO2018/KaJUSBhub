...
# 18 "/Applications/microchip/mplabx/v5.50/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8/pic/include/xc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);


# 13 "/Applications/microchip/xc8/v2.32/pic/include/c90/xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 52 "/Applications/microchip/mplabx/v5.50/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8/pic/include/proc/pic18f4550.h"
...
# 18 "/Applications/microchip/mplabx/v5.50/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8/pic/include/pic18.h"
...
# 4 "/Applications/microchip/mplabx/v5.50/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8/pic/include/__size_t.h"
typedef unsigned size_t;

# 6 "/Applications/microchip/xc8/v2.32/pic/include/c90/stddef.h"
typedef int ptrdiff_t;

# 64 "../USB Stack/GenericTypeDefs.h"
...
INPUT_CONTROLS joystick_input_j1 @ 0x613;
INPUT_CONTROLS joystick_input_j2 @ 0x656;
...
# 7 "/Applications/microchip/xc8/v2.32/pic/include/c90/stdarg.h"
...
# 43 "/Applications/microchip/xc8/v2.32/pic/include/c90/stdio.h"
struct __prbuf
{
char * ptr;
void (* func)(char);
...
# 29 "/Applications/microchip/xc8/v2.32/pic/include/c90/errno.h"
extern int errno;

# 12 "/Applications/microchip/xc8/v2.32/pic/include/c90/conio.h"
...
# 88 "/Applications/microchip/xc8/v2.32/pic/include/c90/stdio.h"
...
# 7 "/Applications/microchip/xc8/v2.32/pic/include/c90/stdlib.h"
...
# 14 "/Applications/microchip/xc8/v2.32/pic/include/c90/string.h"
...
# 384
extern volatile BDT_ENTRY BDT[(3 + 1) * 4];
...
# 54 "../USB Stack/joystick1_hid.h"
typedef struct _USB_HID_DSC_HEADER_J1
{
BYTE bDescriptorType;
WORD wDscLength;
} USB_HID_DSC_HEADER;
...
typedef struct _USB_HID_DSC_J1
{
BYTE bLength;
BYTE bDescriptorType;
WORD bcdHID;
...
extern volatile unsigned char hid_report_in_j1[64];
extern volatile unsigned char hid_report_out_j1[64];
extern volatile CTRL_TRF_SETUP SetupPkt;
extern const BYTE configDescriptor1[];
extern volatile BYTE CtrlTrfData[8];


extern const struct{BYTE report[74];}hid_rpt01_j1;



void USBCheckHIDRequest_j1(void);

# 54 "../USB Stack/joystick2_hid.h"
...
extern volatile unsigned char hid_report_in_j2[64];
extern volatile unsigned char hid_report_out_j2[64];
extern volatile CTRL_TRF_SETUP SetupPkt;
extern const BYTE configDescriptor1[];
extern volatile BYTE CtrlTrfData[8];


extern const struct{BYTE report[74];}hid_rpt01_j2;
...
# 38 "../joystick.c"
void* lastTransmission_j1;
void* lastTransmission_j2;
...
{
joystick[0].joystickSwitch[loop].state = 0;
joystick[0].joystickSwitch[loop].debounceCount = 0;
joystick[0].paddleConnected = FALSE;
joystick[0].paddleX = 0;
joystick[0].paddleY = 0;

joystick[1].joystickSwitch[loop].state = 0;
joystick[1].joystickSwitch[loop].debounceCount = 0;
joystick[1].paddleConnected = FALSE;
joystick[1].paddleX = 0;
joystick[1].paddleY = 0;
}
...
if (RB3 == 0 && joystick[port].joystickSwitch[0].state == 0)
if (joystick[port].joystickSwitch[0].debounceCount > 5)
joystick[port].joystickSwitch[0].state = 1;
else joystick[port].joystickSwitch[0].debounceCount++;

if (RB3 == 1 && joystick[port].joystickSwitch[0].state == 1)
if (joystick[port].joystickSwitch[0].debounceCount > 5)
joystick[port].joystickSwitch[0].state = 0;
else joystick[port].joystickSwitch[0].debounceCount++;

if (RB3 != joystick[port].joystickSwitch[0].state)
joystick[port].joystickSwitch[0].debounceCount = 0;


if (RB5 == 0 && joystick[port].joystickSwitch[1].state == 0)
if (joystick[port].joystickSwitch[1].debounceCount > 5)
joystick[port].joystickSwitch[1].state = 1;
else joystick[port].joystickSwitch[1].debounceCount++;

if (RB5 == 1 && joystick[port].joystickSwitch[1].state == 1)
if (joystick[port].joystickSwitch[1].debounceCount > 5)
joystick[port].joystickSwitch[1].state = 0;
else joystick[port].joystickSwitch[1].debounceCount++;

if (RB5 != joystick[port].joystickSwitch[1].state)
joystick[port].joystickSwitch[1].debounceCount = 0;


if (RB6 == 0 && joystick[port].joystickSwitch[2].state == 0)
if (joystick[port].joystickSwitch[2].debounceCount > 5)
joystick[port].joystickSwitch[2].state = 1;
else joystick[port].joystickSwitch[2].debounceCount++;

if (RB6 == 1 && joystick[port].joystickSwitch[2].state == 1)
if (joystick[port].joystickSwitch[2].debounceCount > 5)
joystick[port].joystickSwitch[2].state = 0;
else joystick[port].joystickSwitch[2].debounceCount++;

if (RB6 != joystick[port].joystickSwitch[2].state)
joystick[port].joystickSwitch[2].debounceCount = 0;


if (RB7 == 0 && joystick[port].joystickSwitch[3].state == 0)
if (joystick[port].joystickSwitch[3].debounceCount > 5)
joystick[port].joystickSwitch[3].state = 1;
else joystick[port].joystickSwitch[3].debounceCount++;

if (RB7 == 1 && joystick[port].joystickSwitch[3].state == 1)
if (joystick[port].joystickSwitch[3].debounceCount > 5)
joystick[port].joystickSwitch[3].state = 0;
else joystick[port].joystickSwitch[3].debounceCount++;

if (RB7 != joystick[port].joystickSwitch[3].state)
joystick[port].joystickSwitch[3].debounceCount = 0;


if (RB4 == 0 && joystick[port].joystickSwitch[4].state == 0)
if (joystick[port].joystickSwitch[4].debounceCount > 5)
joystick[port].joystickSwitch[4].state = 1;
else joystick[port].joystickSwitch[4].debounceCount++;

if (RB4 == 1 && joystick[port].joystickSwitch[4].state == 1)
if (joystick[port].joystickSwitch[4].debounceCount > 5)
joystick[port].joystickSwitch[4].state = 0;
else joystick[port].joystickSwitch[4].debounceCount++;

if (RB4 != joystick[port].joystickSwitch[4].state)
joystick[port].joystickSwitch[4].debounceCount = 0;
}
...
joystick[0].paddleX = readADC(0);
joystick[0].paddleY = readADC(1);
if (joystick[0].paddleX == -1) joystick[0].paddleConnected = FALSE;
else joystick[0].paddleConnected = TRUE;

joystick[1].paddleX = readADC(3);
joystick[1].paddleY = readADC(4);
if (joystick[1].paddleX == -1) joystick[1].paddleConnected = FALSE;
else joystick[1].paddleConnected = TRUE;
}
...
if(!(lastTransmission_j1==0?0:((volatile BDT_ENTRY*)lastTransmission_j1)->STAT.UOWN))
{
...
joystick_input_j1.members.hat_switch.hat_switch = 0x8;
...
if (joystick[0].joystickSwitch[0].state == 1)
joystick_input_j1.members.analog_stick.Y = 0;

if (joystick[0].joystickSwitch[1].state == 1)
joystick_input_j1.members.analog_stick.Y = 255;

if (joystick[0].joystickSwitch[3].state == 1)
joystick_input_j1.members.analog_stick.X = 255;

if (joystick[0].joystickSwitch[2].state == 1)
joystick_input_j1.members.analog_stick.X = 0;

if (joystick[0].joystickSwitch[4].state == 1)
joystick_input_j1.members.buttons.square = 1;


if (joystick[0].paddleConnected == TRUE)
{

joystick_input_j1.members.analog_stick.X = joystick[0].paddleX;
joystick_input_j1.members.analog_stick.Y = joystick[0].paddleY;
...
lastTransmission_j1 = USBTransferOnePacket(1,1,(BYTE*)&joystick_input_j1,sizeof(joystick_input_j1));
}
}
...
if(!(lastTransmission_j2==0?0:((volatile BDT_ENTRY*)lastTransmission_j2)->STAT.UOWN))
{
...
joystick_input_j2.members.hat_switch.hat_switch = 0x8;
...
if (joystick[1].joystickSwitch[0].state == 1)
joystick_input_j2.members.analog_stick.Y = 0;

if (joystick[1].joystickSwitch[1].state == 1)
joystick_input_j2.members.analog_stick.Y = 255;

if (joystick[1].joystickSwitch[3].state == 1)
joystick_input_j2.members.analog_stick.X = 255;

if (joystick[1].joystickSwitch[2].state == 1)
joystick_input_j2.members.analog_stick.X = 0;

if (joystick[1].joystickSwitch[4].state == 1)
joystick_input_j2.members.buttons.square = 1;


if (joystick[1].paddleConnected == TRUE)
{

joystick_input_j2.members.analog_stick.X = joystick[1].paddleX;
joystick_input_j2.members.analog_stick.Y = joystick[1].paddleY;
...
lastTransmission_j2 = USBTransferOnePacket(2,1,(BYTE*)&joystick_input_j2,sizeof(joystick_input_j2));
}
}
...
switch(ADCnumber)
{
case 1 : ADCON0 = 0b00000011;
break;
case 0 : ADCON0 = 0b00000111;
break;
case 3 : ADCON0 = 0b00001011;
break;
case 4 : ADCON0 = 0b00001111;
break;
}
